                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" role="form" method="POST" action="./Controlador.php" name="formLogin">
                                        <div class="form-group">
                                            <input id="InputCorreo" class="form-control form-control-user" placeholder="Correo Electrónico" name="email" type="email" autofocus>
                                        </div>
                                        <div class="form-group">
                                            <input id="InputPassword" class="form-control form-control-user" placeholder="Contrasña" name="password" type="password" value="">
                                        </div>
                                        <div class="form-group">
                                        </div>
                                        <div>
